...
const INSTITUTIONS = [
  ...
  { id: 'kmtc_kericho', name: 'Kenya Medical Training College (KMTC) — Kapkatet Campus', ownership: 'public', type: 'tvet', location: 'Kapkatet', county: 'Kericho', accreditation: 'TVETA Registered', website: 'https://kmtc.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'kmtc' },
  ...
  { id: 'kmtc_mombasa', name: 'Kenya Medical Training College (KMTC) — Port Reitz Campus', ownership: 'public', type: 'tvet', location: 'Port Reitz, Mombasa', county: 'Mombasa', accreditation: 'TVETA Registered', website: 'https://kmtc.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'kmtc' },
  { id: 'kmtc_mombasa_island', name: 'Kenya Medical Training College (KMTC) — Mombasa Campus', ownership: 'public', type: 'tvet', location: 'Tononoka, Mombasa Island', county: 'Mombasa', accreditation: 'TVETA Registered', website: 'https://kmtc.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'kmtc' },
  { id: 'kmtc_maua', name: 'Kenya Medical Training College (KMTC) — Maua Campus', ownership: 'public', type: 'tvet', location: 'Maua, Igembe South', county: 'Meru', accreditation: 'TVETA Registered', website: 'https://kmtc.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: false, fee_regime: 'kmtc' },
  { id: 'kmtc_miathene', name: 'Kenya Medical Training College (KMTC) — Miathene Campus', ownership: 'public', type: 'tvet', location: 'Miathene, Tigania West', county: 'Meru', accreditation: 'TVETA Registered', website: 'https://kmtc.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: false, fee_regime: 'kmtc' },
  { id: 'aiu', name: 'Africa International University (AIU)', ownership: 'private', type: 'university', location: 'Karen, Nairobi', county: 'Nairobi', accreditation: 'CUE Chartered', website: 'https://www.aiu.ac.ke', modes: ['full_time', 'part_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  { id: 'kag_east', name: 'KAG EAST University', ownership: 'private', type: 'university', location: 'Buru Buru, Nairobi', county: 'Nairobi', accreditation: 'CUE Chartered', website: 'https://kag.east.ac.ke', modes: ['full_time', 'part_time'], has_workstudy: false, has_hostel: false, fee_regime: 'private_own_rate' },
  { id: 'puea', name: 'Presbyterian University of East Africa (PUEA)', ownership: 'private', type: 'university', location: 'Thogoto, Kikuyu', county: 'Kiambu', accreditation: 'CUE Chartered', website: 'https://puea.ac.ke', modes: ['full_time', 'part_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  { id: 'iuk', name: 'Islamic University of Kenya (IUK)', ownership: 'private', type: 'university', location: 'Kisaju, Nairobi-Namanga Highway', county: 'Kajiado', accreditation: 'CUE Chartered', website: 'https://www.iuk.ac.ke', modes: ['full_time', 'part_time'], has_workstudy: false, has_hostel: false, fee_regime: 'private_own_rate' },
  { id: 'kijabe_chs', name: 'AIC Kijabe College of Health Sciences', ownership: 'private', type: 'tvet', location: 'Kijabe Mission Hospital, Lari', county: 'Kiambu', accreditation: 'Nursing Council of Kenya accredited', website: 'https://kchs.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  ...
  { id: 'mandera_tti', name: 'Mandera Technical Training Institute', ownership: 'public', type: 'tvet', location: 'Mandera', county: 'Mandera', accreditation: 'Public technical training institute \u00b7 TVETA registered \u00b7 KNEC examined \u00b7 KUCCPS placement', website: 'https://manderatti.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'tvet_consolidated' },
...
,
  ...
  { id: 'ueab', name: 'University of Eastern Africa, Baraton', ownership: 'private', type: 'university', location: 'Baraton, near Eldoret', county: 'Nandi', accreditation: 'CUE Chartered - Seventh-day Adventist university, one of the 32 chartered private universities', website: 'https://ueab.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  { id: 'gluk', name: 'Great Lakes University of Kisumu', ownership: 'private', type: 'university', location: 'Kisumu', county: 'Kisumu', accreditation: 'CUE Chartered - health-sciences focused private university, one of the 32 chartered private universities', website: 'https://www.gluk.ac.ke', modes: ['full_time', 'evening', 'online'], has_workstudy: false, has_hostel: false, fee_regime: 'private_own_rate' },
  { id: 'khu', name: 'Kenya Highlands University', ownership: 'private', type: 'university', location: 'Kericho town', county: 'Kericho', accreditation: 'CUE Chartered - evangelical Christian university founded 1989, one of the 32 chartered private universities', website: 'https://khu.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  { id: 'scott', name: 'Scott Christian University', ownership: 'private', type: 'university', location: 'Machakos town', county: 'Machakos', accreditation: 'CUE Chartered - one of the 32 chartered private universities', website: 'https://scott.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'private_own_rate' },
  { id: 'cuk', name: 'The Co-operative University of Kenya', ownership: 'public', type: 'university', location: 'Karen main campus, and the Nairobi Campus', county: 'Nairobi', accreditation: 'Public university, CUE chartered; degrees placed through KUCCPS, with diploma and certificate programmes run through its ITVET institute', website: 'https://cuk.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: false, fee_regime: 'public_university' },
  { id: 'chuka', name: 'Chuka University', ownership: 'public', type: 'university', location: 'Chuka town', county: 'Tharaka-Nithi', accreditation: 'Public chartered university; degrees placed through KUCCPS. Runs 65 bachelor, 25 diploma and 20 certificate programmes', website: 'https://www.chuka.ac.ke', modes: ['full_time', 'evening', 'weekend'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'seku', name: 'South Eastern Kenya University (SEKU)', ownership: 'public', type: 'university', location: 'Kwa Vonza, Kitui', county: 'Kitui', accreditation: 'Public chartered university established 2008; degrees placed through KUCCPS. Also runs certificate, diploma and TVET programmes', website: 'https://www.seku.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'mmarau', name: 'Maasai Mara University', ownership: 'public', type: 'university', location: 'Narok town', county: 'Narok', accreditation: 'Public chartered university; seven schools including Tourism and Hospitality and Natural Resources. Degrees placed through KUCCPS', website: 'https://www.mmarau.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'laikipia_uni', name: 'Laikipia University', ownership: 'public', type: 'university', location: 'Nyahururu', county: 'Laikipia', accreditation: 'Public chartered university; runs degree, diploma and certificate programmes. Degrees placed through KUCCPS', website: 'https://laikipia.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'rongo_uni', name: 'Rongo University', ownership: 'public', type: 'university', location: 'Rongo, about 8km outside Rongo town', county: 'Migori', accreditation: 'Public chartered university; runs degree, diploma and certificate programmes. Degrees placed through KUCCPS', website: 'https://www.rongovarsity.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'pwani', name: 'Pwani University', ownership: 'public', type: 'university', location: 'Kilifi, about 60km north of Mombasa', county: 'Kilifi', accreditation: 'Public chartered university; degrees placed through KUCCPS. Its PU-TVET College runs 75 diploma and certificate programmes at Levels 5 and 6', website: 'https://www.pu.ac.ke', modes: ['full_time'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'kyu', name: 'Kirinyaga University', ownership: 'public', type: 'university', location: 'Kutus, Kerugoya', county: 'Kirinyaga', accreditation: 'Public chartered university; publishes degree, diploma and certificate entry bars separately. Degrees placed through KUCCPS', website: 'https://www.kyu.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  { id: 'mut', name: "Murang'a University of Technology", ownership: 'public', type: 'university', location: "1.5km from Murang'a town", county: "Murang'a", accreditation: 'Public chartered university, successor to a JKUAT constituent college; runs degree, diploma, certificate and craft courses. Degrees placed through KUCCPS', website: 'https://www.mut.ac.ke', modes: ['full_time', 'evening'], has_workstudy: false, has_hostel: true, fee_regime: 'public_university' },
  ...
  { "id":"dti_naivasha","name":"Dairy Training Institute (DTI), Naivasha","ownership":"public","type":"tvet","location":"Naivasha, Nakuru","county":"Nakuru","accreditation":"State Department for Livestock Development, Ministry of Agriculture and Livestock Development","website":"https://www.dtinaivasha.ac.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate" },
  { "id":"ahiti_nyahururu","name":"Animal Health and Industry Training Institute (AHITI) — Nyahururu","ownership":"public","type":"tvet","location":"Nyahururu, Laikipia","county":"Laikipia","accreditation":"State Department for Livestock Development; Kenya Veterinary Board recognised","website":null,"modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate" },
  { "id":"ahiti_wajir","name":"Animal Health and Industry Training Institute (AHITI) — Wajir","ownership":"public","type":"tvet","location":"Wajir","county":"Wajir","accreditation":"State Department for Livestock Development; Kenya Veterinary Board recognised","website":null,"modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate" },
  ...
  {"id": "kmtc_chemolingot", "name": "Kenya Medical Training College (KMTC) — Chemolingot Campus", "ownership": "public", "type": "tvet", "location": "Chemolingot", "county": "Baringo", "accreditation": "TVETA Registered", "website": "https://kmtc.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "kmtc"},
  {"id": "garissa_university", "name": "Garissa University", "ownership": "public", "type": "university", "location": "Garissa", "county": "Garissa", "accreditation": "CUE Chartered", "website": "https://gau.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "tom_mboya_university", "name": "Tom Mboya University", "ownership": "public", "type": "university", "location": "Homa Bay", "county": "Homa Bay", "accreditation": "CUE Chartered", "website": "https://tmu.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "kaimosi_friends_university", "name": "Kaimosi Friends University", "ownership": "public", "type": "university", "location": "Kaimosi", "county": "Vihiga", "accreditation": "CUE Chartered", "website": "https://kafu.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "kibabii_university", "name": "Kibabii University", "ownership": "public", "type": "university", "location": "Bungoma", "county": "Bungoma", "accreditation": "CUE Chartered", "website": "https://kibu.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "university_of_embu", "name": "University of Embu", "ownership": "public", "type": "university", "location": "Embu", "county": "Embu", "accreditation": "CUE Chartered", "website": "https://embuni.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "jooust", "name": "Jaramogi Oginga Odinga University of Science and Technology (JOOUST)", "ownership": "public", "type": "university", "location": "Bondo", "county": "Siaya", "accreditation": "CUE Chartered", "website": "https://jooust.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "karatina_university", "name": "Karatina University", "ownership": "public", "type": "university", "location": "Karatina", "county": "Nyeri", "accreditation": "CUE Chartered", "website": "https://karu.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  {"id": "must_meru", "name": "Meru University of Science and Technology (MUST)", "ownership": "public", "type": "university", "location": "Meru", "county": "Meru", "accreditation": "CUE Chartered", "website": "https://must.ac.ke", "modes": ["full_time"], "has_workstudy": false, "has_hostel": true, "fee_regime": "public_university"},
  ...
  {"id":"clive_irvine_chs","name":"Clive Irvine College of Health Sciences (PCEA Chogoria)","ownership":"private","type":"tvet","location":"PCEA Chogoria Hospital, Chogoria","county":"Tharaka-Nithi","accreditation":"Nursing Council of Kenya accredited; TVETA registered","website":"https://pceachogoriahospital.org","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"methodist_chs_maua","name":"Methodist College of Health Sciences, Maua","ownership":"private","type":"tvet","location":"Maua Methodist Hospital, Igembe South","county":"Meru","accreditation":"Nursing Council of Kenya accredited","website":"https://mchs.ac.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"pcea_kikuyu_son","name":"PCEA Kikuyu Hospital School of Nursing","ownership":"private","type":"tvet","location":"PCEA Kikuyu Hospital, Kikuyu","county":"Kiambu","accreditation":"Nursing Council of Kenya accredited; TVETA registered","website":"https://www.pceakikuyuhospital.org","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"catherine_mcauley","name":"Catherine McAuley Nursing School (The Mater Hospital)","ownership":"private","type":"tvet","location":"The Mater Misericordiae Hospital, Dunga Road, South B","county":"Nairobi","accreditation":"Nursing Council of Kenya accredited; TVETA registered","website":"https://www.materkenya.com","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"manna_bible","name":"Manna Bible Institute and School of Missions","ownership":"private","type":"college","location":"Ongata Rongai, near Africa Nazarene University","county":"Kajiado","accreditation":"Interdenominational Bible college teaching since 1986, registered by TVETA as a technical and vocational college","website":"https://www.mannabibleinstitute.org","modes":["full_time","part_time","online"],"has_workstudy":false,"has_hostel":false,"fee_regime":"private_own_rate"},
  {"id":"moffat_bible","name":"Moffat Bible College","ownership":"private","type":"college","location":"Kijabe, on the Africa Inland Church campus","county":"Kiambu","accreditation":"Opened 11 February 1929 as the W.Y. Moffat Memorial Bible Training Institute by the Africa Inland Mission; part of the Africa Inland Church and open to students of other denominations","website":"https://moffatbiblecollege.org","modes":["full_time","online"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"kwsti","name":"Kenya Wildlife Service Training Institute (KWSTI)","ownership":"public","type":"tvet","location":"Naivasha, about 90km from Nairobi","county":"Nakuru","accreditation":"Started 1985 as the Naivasha Wildlife and Fisheries Training Institute; registered by TVETA as a public technical and vocational college, TVETA/PUBLIC/TVC/0004/2018, and listed on the KUCCPS placement portal","website":"https://www.kws.go.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate"},
  {"id":"kfc_londiani","name":"Kenya Forestry College (KFC) — Londiani","ownership":"public","type":"tvet","location":"Masaita Forest Block, Londiani","county":"Kericho","accreditation":"TVETA-registered training arm of the Kenya Forest Service, established under section 17 of the Forest Conservation and Management Act 2016; a parastatal college under the Ministry of Environment and Forestry","website":"https://www.kfc.ac.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate"},
  {"id":"carlile","name":"Carlile College (Church Army Africa)","ownership":"private","type":"college","location":"Jogoo Road, Nairobi","county":"Nairobi","accreditation":"Education ministry of Church Army Africa, an Anglican society of mission; teaching since 1958, affiliated to St Paul’s University and accredited by the Accrediting Council for Theological Education in Africa (ACTEA)","website":"https://carlilecollege.ac.ke","modes":["full_time","part_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"private_own_rate"},
  {"id":"kise","name":"Kenya Institute of Special Education (KISE)","ownership":"public","type":"institute","location":"Off Kasarani-Mwiki Road, Nairobi","county":"Nairobi","accreditation":"Semi-autonomous government agency under the Ministry of Education, established 1986; the national institute for special needs education training, research and assessment","website":"https://kise.ac.ke","modes":["full_time","part_time","online"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate"},
  {"id":"kism","name":"Kenya Institute of Surveying and Mapping (KISM)","ownership":"public","type":"institute","location":"Off Thika Superhighway, Ruaraka, Nairobi","county":"Nairobi","accreditation":"Training arm of the State Department for Lands and Physical Planning, established 1994 with the Survey of Kenya; trains in land survey, cartography, photogrammetry, remote sensing and printing technology","website":"https://kism.ac.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate"},
  {"id":"imtr","name":"Institute for Meteorological Training and Research (IMTR)","ownership":"public","type":"institute","location":"Dagoretti Corner, Ngong Road, Nairobi","county":"Nairobi","accreditation":"Training branch of the Kenya Meteorological Department and a World Meteorological Organization Regional Training Centre serving English-speaking Africa","website":"https://kimtr.ac.ke","modes":["full_time"],"has_workstudy":false,"has_hostel":true,"fee_regime":"parastatal_own_rate"},
  {"id":"kitale_poly","name":"Kitale National Polytechnic","ownership":"public","type":"tvet","location":"Kitale town, Trans Nzoia","county":"Trans Nzoia","accreditation":"Legal Notice 95 of 2016 (Kitale National Polytechnic Order) · TVETA/PUBLIC/NP/0001/2017 · KNEC and CDACC examined","website":"https://www.kitalenationalpolytechnic.ac.ke","modes":["full_time","part_time"],"has_workstudy":true,"has_hostel":true,"fee_regime":"tvet_consolidated"}
];
