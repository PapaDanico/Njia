...
const PLACEMENT_CALENDAR = [
  ...
  { name: 'KMTC and Kenya Utalii College — reopened applications', opens: '2026-09-08', closes: '2026-09-14',
    ...
    verified: '2026-09-08' },
  { name: 'Railway Training Institute — September intake (civil engineering and building)', opens: '2026-09-01', closes: '2026-09-25',
    note: 'KNEC-examined civil engineering and building technology programmes at RTI in South B, Nairobi. This is the institute\u2019s own intake rather than a KUCCPS window, so it is applied for directly. A non-refundable application fee of Ksh 1,000 applies.',
    source: 'Railway Training Institute September 2026 intake advertisement, naming a deadline of Friday 25 September 2026 and listing the KNEC-examined programmes; rti.ac.ke separately publishes January, March and September intakes. The OPENING date is the cycle shape rather than a published day \u2014 only the closing date is relied on here, as with the Utalii row above.',
    verified: '2026-09-18' },
