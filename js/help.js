...
const HELP_FAQ = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Can I use Njia if I\'m not in Kenya?',
        'You can, but the course, fee and funding data is Kenya-specific — it won\'t be useful for education decisions outside Kenya\'s system.'],
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ['A public university shows no fee. So what will I actually pay?', 'A per-programme price for a public university <strong>no longer exists</strong>, which is why Njia shows none rather than a guess. Kenya retired the Differentiated Unit Cost in May 2023 and replaced it with the <strong>Student-Centred Funding Model</strong>: what you pay is set by your household, not by your course.<br><br>A <strong>Means Testing Instrument</strong> run by HELB places you in one of five bands, weighing family income, family size, the type of school you attended, marginalisation and disability. Each band fixes how the cost is split between a government scholarship, a HELB loan and your family:<br><br><strong>Band 1</strong> (previously &ldquo;vulnerable&rdquo;) &mdash; 70% scholarship + 25% loan, household pays <strong>5%</strong>.<br><strong>Band 2</strong> (extremely needy) &mdash; 70% scholarship + 30% loan, household pays <strong>nothing</strong>.<br><strong>Band 3</strong> (needy, reported around household income up to Ksh 70,000 a month) &mdash; 50% scholarship + 30% loan, household pays <strong>20%</strong>; upkeep loan Ksh 50,000.<br><strong>Band 4</strong> (less needy, reported up to Ksh 120,000 a month) &mdash; 40% scholarship + 30% loan, household pays <strong>30%</strong>; upkeep loan Ksh 45,000.<br><strong>Band 5</strong> &mdash; 30% scholarship + 30% loan, household pays <strong>40%</strong>.<br><br><strong>How to use this.</strong> The percentages are of the course cost, so a cheaper programme lowers your share in shillings even when your band does not move. Two people on the same course in the same lecture hall can owe very different amounts, and that is the model working as designed rather than an error. Apply through the HEF portal at <strong>hef.co.ke</strong> and HELB, and do it in the application window &mdash; a band is assigned from what you submit.<br><br><strong>And the scholarship half does not reach a private university.</strong> Under this model a student placed at a private university can apply for the <strong>HELB loan only</strong> &mdash; 31 of Kenya&rsquo;s 32 chartered private universities are HELB-eligible for the 2026 cycle &mdash; but the <strong>government scholarship is reserved for public universities and the Open University of Kenya</strong>. That is the largest share of the split: the scholarship is 30% to 70% of the course cost depending on your band, so a Band 2 student who would pay <strong>nothing</strong> from the household at a public university is, at a private one, looking at the loan and the family covering the rest. This is not a reason to avoid private institutions &mdash; Njia lists them because they often run the programme you want and publish their fees &mdash; but it is the single biggest difference in what you will actually pay, and it is invisible on a course card. Check the KUCCPS eligibility list for the cycle you are applying in, because it is republished each year.<br><br><strong>What Njia will not tell you:</strong> which band you will land in. The instrument weighs household circumstances Njia does not hold and should not hold. The bands and shares above are the published national framework, reported consistently across Kenyan coverage in 2026; the portal gives your own figure. Confirm the current percentages there before you budget, because a funding model on its fifth revision in forty years can move again.'],
      ...
      ['How does government funding work now?', 'Kenya moved to the Higher Education Funding (HEF) model: instead of a flat loan, students are means-tested into funding bands combining a government scholarship, a HELB loan and a household contribution. You apply through the HEF portal with each intake. <strong>Where you train changes what you can get.</strong> For 2026, public universities and the 272 TVET colleges under the Ministry of Education are eligible for both the scholarship and the loan; KMTC and the other public colleges run by other ministries are eligible for the <strong>HELB loan only</strong>, and private universities likewise get the loan but not the scholarship. Check the KUCCPS eligibility list for your cycle, because it is republished each year.'],
      ['What does TVET actually cost?', 'Public TVET is government-subsidised, and from May 2026 public institutions charge a single consolidated annual fee of Ksh 67,189 including assessment fees. That figure anchors the public-TVET fees in this catalogue. It is worth knowing why it exists: public TVET charges had nearly doubled in a year, which left some technical colleges costing more than a public university and was driving enrolment down. The rate was set to stop that. So if a college quotes you materially more than Ksh 67,189 a year for a KUCCPS-placed programme, ask what the extra is for \u2014 that is a question worth putting to the registrar before you pay. A county vocational training centre is a different case: those are funded by the county and set their own, usually much lower, charge.'],
      ['I got an E. Is there anything for me?',
        'Yes — the artisan route. KUCCPS sets the minimum for an Artisan certificate (KNQF Level 4) at a mean grade of E, and opens Level 4 to everyone who scored C down to E. It runs about a year, and it is the entry point for the building and mechanical trades: masonry, carpentry and joinery, plumbing, electrical installation, motor vehicle mechanics, welding and fabrication, painting and decoration, refrigeration, hairdressing and beauty, food and beverage, and computer repair. Filter the Course Matcher to Artisan to see them, at a national polytechnic in Nairobi and at a county vocational training centre in Samburu. From there you can ladder up to a Craft certificate (Level 5) and then a Diploma (Level 6) without going back to Form Four. Some centres publish no fee structure at all; where that is true Njia says Not published rather than showing a guessed number, and you should ring the centre for the fee per term, what county capitation covers, and whether tools and the NITA trade-test fee are charged separately.'],
      ['I never sat KCSE, or I left before Form Four. Is anything open to me?',
        'Yes, but not through KUCCPS — its artisan minimum still assumes a KCSE grade of E. Faith-based and mission training centres are the route that does not. Five are in the Course Matcher — filter to Artisan. Christian Industrial Training Centre (Anglican Church of Kenya) admits to its KNEC artisan certificates on a KCPE certificate, at Pumwani and in Mombasa. YMCA\'s National Training Institute at Shauri Moyo, running since 1966, takes KCPE holders, KCSE D- and below, and anyone who left before Form Four. St. Kizito in Githurai, founded on Cardinal Otunga\'s initiative, teaches primary school leavers alongside secondary ones. Don Bosco Boys Technical Training Centre in Karen admits by interview and boards its trainees, though it takes boys only. None of them publishes a fee structure, so ring and ask what is charged and what is sponsored.'],
      ['Is a trade actually worth it, or should I retake?',
        'Look at the numbers before you assume. Kenya has roughly 5,000 engineers and architects but fewer than 2,000 trained plumbers, painters and masons between them, and two-thirds of developers name skilled-worker shortage as the main brake on building. Certified artisans are reported at Ksh 2,500–3,000 a day, which compares well with what many diploma and degree holders start on. Two honest cautions: that is a day rate, not a salary — work is irregular and seasonal, with no employer pension, paid leave or sick pay — and it is the rate for certified artisans. Uncertified work pays a fraction of it, which is the whole argument for doing the certificate rather than just picking up the tools.'],
      ['Does any real scholarship ask me to pay a registration fee?',
        'No. <strong>No genuine scholarship or bursary in Kenya charges you to apply.</strong> Anyone asking for money to &ldquo;register&rdquo;, &ldquo;unlock&rdquo;, &ldquo;process&rdquo; or &ldquo;guarantee&rdquo; an award is defrauding you, and this is the most common way money is taken from families at exactly the moment they have least of it.<br><br><strong>The specific things to know.</strong> HEF and HELB applications are free and happen only on <strong>hef.co.ke</strong>, <strong>helb.co.ke</strong>, the HELB app or USSD <strong>*642#</strong> &mdash; lookalike sites and WhatsApp links are the usual trap. NG-CDF and county bursary forms come from the constituency or ward office, never from an individual selling &ldquo;slots&rdquo;. The large international programmes &mdash; Chevening, DAAD, Fulbright, Commonwealth, Mastercard Foundation &mdash; never work through a paid middleman, whatever an agent promising &ldquo;guaranteed placement&rdquo; tells you. <strong>Never share your M-PESA PIN, an OTP code, or photographs of your ID</strong> with anyone claiming to be processing funding; no legitimate funder needs any of the three. If you are unsure, ring the institution&rsquo;s financial aid office or the constituency NG-CDF office and ask them directly rather than the person who contacted you.'],
      ['What documents should I have ready before any funding window opens?',
        'One folder serves almost every application on the Funding tab, and assembling it in advance matters more than it sounds: <strong>missing stamps, missing IDs and names that do not match between documents are the top reasons applications are rejected</strong> &mdash; not weak need and not weak grades.<br><br><strong>Identity and academics:</strong> national ID or Maisha Card, both sides (birth certificate if you are still a minor); KCPE and KCSE result slips with their index numbers; your admission letter and admission number; a fee structure and current fee-balance statement stamped by the institution; passport photos on paper and as a file; transcripts if you are already studying.<br><br><strong>Need and verification:</strong> your parents&rsquo; or guardians&rsquo; ID copies and phone numbers; death certificates for any deceased parent (this materially changes your assessed need band, so never leave it out); NCPWD card or medical reports if you have a disability; a chief&rsquo;s or assistant chief&rsquo;s letter confirming where you live and your circumstances; a letter from a religious leader, which several bursaries and most faith-based funders ask for; any letter from a previous sponsor.<br><br><strong>Money and guarantees:</strong> a bank account or M-PESA number registered in <strong>your own name</strong>; two guarantors&rsquo; ID numbers and phone numbers for HELB; and one honest page describing your situation, which you can reuse everywhere.<br><br>Scan it all to PDF, keep a copy on your phone and a copy in the cloud, and get every stamp before you travel to submit rather than after.'],
