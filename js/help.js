...
const HELP_FAQ = [
  {
    ...
    items: [
      ...
      ['What exactly am I choosing — a pathway, or something narrower?', 'Something narrower, and this trips people up. A pathway is the top level; inside it sits a <strong>track</strong>, and inside that a <strong>coded three-subject combination</strong>. STEM runs Pure Sciences, Applied Sciences and Technical Studies. Social Sciences runs Humanities, Business Studies, Languages, Foreign Languages and Religious Education. Arts and Sports Science runs Performing and Visual Arts, and Sports Science. The Ministry publishes the whole combination table with codes at <strong>selection.education.go.ke</strong> — but <strong>your school only offers some of them</strong>, so the school you are placed in narrows your combination just as much as the pathway does. Check which combinations a school actually offers before you rank it.'],
